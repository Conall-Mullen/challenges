...
console.log("Name starts with G?: ", firstAnimalStartingWithLetterG);
...
console.log(
  "Sorted alphabetically by animal name: ",
...
console.log("Sorted by weight descending: ", animalsSortedByWeightReversed);

const animalWithWeightMoreThanFivehundredExists = animals.some(
  (animal) => animal.weight > 500
);
console.log(
  "Animal that weighs more than 500?: ",
...
//filter to get all african animals
//
const weightOfAllAnimalsInAfrica = animals
  .filter((animal) => animal.continents.includes("Africa"))
  .map((animal) => animal.weight);
const weightCombined = weightOfAllAnimalsInAfrica.reduce(
  (accumulator, currentValue) => accumulator + currentValue
);
console.log("Weight of all animals in Africa: ", weightCombined);
